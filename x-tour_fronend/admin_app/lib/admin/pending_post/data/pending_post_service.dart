...
abstract class PendingPostService extends ChopperService {
  ...
  @Post(path: "/{id}")
  Future<Response<Posts>> approvePendingPost({@Path("id") required String id, @Body() required  Posts post, @Header("Authorization") required String accesstoken});
  ...
  static PendingPostService create([ChopperClient? client]) => _$PendingPostService(client);
}

      ...
      child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Stack(
              children: [
                Image.network(
                  widget.journal.creator!.profilePicture!,
                  width: double.infinity,
                  height: 400, 
                  fit: BoxFit.cover,
                ),
      ...
      child: Row(children: [
        ...
        Spacer(),
          IconButton(
            ...
            onPressed: () {
              widget.pendingJournalBloc.add(ApprovePendingJournal(id: widget.journal.id!, journal: widget.journal));
            },
          ),
          IconButton(
            icon: Icon(Icons.close),
            onPressed: () {
              widget.pendingJournalBloc.add(DeletePendingJournal(id: widget.journal.id!));
            },
          ),
